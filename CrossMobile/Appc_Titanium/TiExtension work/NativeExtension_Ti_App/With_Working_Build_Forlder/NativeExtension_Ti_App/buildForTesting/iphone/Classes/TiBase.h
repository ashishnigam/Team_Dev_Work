...
// in simulator we redefine to format for NativeExtension Developer console
...
{\
	NSString * exceptionName = [@"org.nativeextension." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nativeextension";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINativeExtensionNativeItemNone = -1, 
	UINativeExtensionNativeItemSpinner = -2,
	UINativeExtensionNativeItemProgressBar = -3,
	
	UINativeExtensionNativeItemSlider = -4,
	UINativeExtensionNativeItemSwitch = -5,
	UINativeExtensionNativeItemMultiButton = -6,
	UINativeExtensionNativeItemSegmented = -7,
	
	UINativeExtensionNativeItemTextView = -8,
	UINativeExtensionNativeItemTextField = -9,
	UINativeExtensionNativeItemSearchBar = -10,
	
	UINativeExtensionNativeItemPicker = -11,
	UINativeExtensionNativeItemDatePicker = -12,
	
	UINativeExtensionNativeItemInfoLight = -13,
	UINativeExtensionNativeItemInfoDark = -14,
	
	UINativeExtensionNativeItemDisclosure = -15,
	
	UINativeExtensionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NativeExtension instances of
