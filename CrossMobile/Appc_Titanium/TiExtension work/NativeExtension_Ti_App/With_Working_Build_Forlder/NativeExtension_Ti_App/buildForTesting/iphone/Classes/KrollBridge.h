...
@interface NativeExtensionObject : KrollCoverageObject {
#else
@interface NativeExtensionObject : KrollObject {
#endif
@private
...
extern NSString * NativeExtension$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	NativeExtensionObject *_nativeextension;
    KrollObject* console;
	BOOL shutdown;
