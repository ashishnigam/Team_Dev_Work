...
//Rare exceptions to indicate a bug in the _nativeextension code (Eg, function that a subclass should have implemented)
...
/**
 The base class for NativeExtension proxies.
 */
