...
/**
 Base class for all NativeExtension views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the NativeExtension view hierarchy (such as wrapped iOS UIViews) was touched.
