...
//@interface NativeExtensionObject : NSObject
//@end

@interface NativeExtensionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NativeExtensionObject class]])
		{
			for (NSString *key in [[(NativeExtensionObject*)o modules] allKeys])
			{
