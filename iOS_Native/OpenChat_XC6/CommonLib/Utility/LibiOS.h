...
#define isIOS8() (([[NSNumber numberWithFloat:[[[UIDevice currentDevice] systemVersion] floatValue]] intValue] >= 8) && ([[NSNumber numberWithFloat:[[[UIDevice currentDevice] systemVersion] floatValue]] intValue] < 9))
...
#define isIOSGreaterThan8() ([[NSNumber numberWithFloat:[[[UIDevice currentDevice] systemVersion] floatValue]] intValue] >= 8)
