...
@implementation WorldLoveNetwork_boy
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    return [maleCollection count];
}

// The cell that is returned must be retrieved from a call to -dequeueReusableCellWithReuseIdentifier:forIndexPath:
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    static NSString *identifier = @"Cell_Boy";
    
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
    
    UIImageView *personImageView = (UIImageView *)[cell viewWithTag:707];
    personImageView.image = [UIImage imageNamed:[maleCollection objectAtIndex:indexPath.item]];
    cell.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"boy_background.jpg"]];
    return cell;
