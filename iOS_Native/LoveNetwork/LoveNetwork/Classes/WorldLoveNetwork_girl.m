...
@implementation WorldLoveNetwork_girl
...
//    self.navigationItem.rightBarButtonItem = addButton;
    ...
    femaleCollection = [self getFemaleCollection:@"female"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    personImageView.image = [UIImage imageNamed:[femaleCollection objectAtIndex:indexPath.item]];
